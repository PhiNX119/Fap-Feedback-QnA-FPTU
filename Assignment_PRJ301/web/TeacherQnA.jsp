        ...
        <div class="center">
            ...
            <div style="height: 205px; width: 1000px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <a style="height: 30px" class="button" href="AddQnA.jsp">Add new QnA</a>
                    </div>
                    <div>
                ...
                <br>
                <div>
                    <a style="height: 30px" class="button" href="waiting">Waiting Question</a>
                </div>
                ...
                <div style="margin-top: 20px">
                    <table border="1" class="listquestion">
                        <tr style="background-color: #6b90da; color: white; height: 35px">
                            <td class="hmm">TITLE</td>
                            <td class="hmm">CATEGORY</td>
                        ...
                        <c:forEach items="${listQuestion}" var="q">                            
                            <tr style="font-size: 13px; height: 35px" class="autofindelement">
                                ...
                                <td>
                                    <span class="cat">UserGuide</span>
                                </td>
                                <td class="hmm">
                                    <a href="qna?questionId=${q.getQuestionId()}">View </a>|
                                    <a onclick="return confirmDelete();" href="qna?questionId=${q.getQuestionId()}&delete=1">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
