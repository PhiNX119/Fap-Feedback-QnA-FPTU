    ...
    <body>
        ...
        <div class="center">
            ...
            <div style="border-bottom: solid 1px #f5f5f5; height: 205px; width: 1000px;">
                ...
                <div>
                    <h2>List of feedbacks for ${loginStudentData.getDisplayname()} (${loginStudentData.getStudentId()})</h2>
                </div>
                ...
                <table class="listfeedback">
                    ...
                    <c:forEach items="${listSubject}" var="s">
                        <tr style="font-size: 13px">
                            ...
                            <td></td>
                            <c:choose>
                                <c:when test="${feedback.checkFeedbackExist(s.getSubjectId(), loginStudentData.getStudentId()) == true}">                                    
                                    <td>
                                        <a href="comment?subjectId=${s.getSubjectId()}">Edit Comment </a>|
                                        <a href="retake?subjectId=${s.getSubjectId()}">Re Take</a>
                                    </td>
                                </c:when>
                                <c:otherwise>
                                    <td><a href="feedback?subjectId=${s.getSubjectId()}">Open</a></td>
                                </c:otherwise>
                            </c:choose>
                        </tr>
                    </c:forEach>
